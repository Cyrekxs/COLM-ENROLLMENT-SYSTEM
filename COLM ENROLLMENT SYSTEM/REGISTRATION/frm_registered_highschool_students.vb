Public Class frm_registered_highschool_students
    ...
    Public Sub LoadStudents()
        ...
        Using conn As New SqlConnection(StringConnection)
            ...
            Select Case cmbFilter.Text
                Case "STUDENT NO"
                    SQLQuery = "SELECT ROWID,TBL_STUDENT_INFORMATION.STUDENT_NUMBER,LASTNAME + CASE EXTENSION_NAME WHEN 'N.A' THEN '' WHEN '' THEN '' ELSE ' ' + EXTENSION_NAME END + ', ' + FIRSTNAME + ' ' + CASE MIDDLENAME WHEN 'N.A' THEN '' WHEN '' THEN '' ELSE ' ' + MIDDLENAME END AS STUDENT_NAME,COURSECODE,YRLVL,SECTIONCODE,REGISTEREDDATE,REGISTEREDBY FROM TBL_STUDENT_INFORMATION INNER JOIN TBL_STUDENT_REGISTERED ON TBL_STUDENT_INFORMATION.STUDENT_NUMBER = TBL_STUDENT_REGISTERED.STUDENT_NUMBER WHERE TBL_STUDENT_REGISTERED.STUDENT_NUMBER LIKE @search AND TBL_STUDENT_REGISTERED.EDUCATION_LEVEL = 'JUNIOR HIGH' AND TBL_STUDENT_REGISTERED.ACADEMIC_YEAR = @ay ORDER BY LASTNAME,FIRSTNAME ASC"
                Case "STUDENT NAME"
                    SQLQuery = "SELECT ROWID,TBL_STUDENT_INFORMATION.STUDENT_NUMBER,LASTNAME + CASE EXTENSION_NAME WHEN 'N.A' THEN '' WHEN '' THEN '' ELSE ' ' + EXTENSION_NAME END + ', ' + FIRSTNAME + ' ' + CASE MIDDLENAME WHEN 'N.A' THEN '' WHEN '' THEN '' ELSE ' ' + MIDDLENAME END AS STUDENT_NAME,COURSECODE,YRLVL,SECTIONCODE,REGISTEREDDATE,REGISTEREDBY FROM TBL_STUDENT_INFORMATION INNER JOIN TBL_STUDENT_REGISTERED ON TBL_STUDENT_INFORMATION.STUDENT_NUMBER = TBL_STUDENT_REGISTERED.STUDENT_NUMBER WHERE LASTNAME + FIRSTNAME LIKE @search AND TBL_STUDENT_REGISTERED.EDUCATION_LEVEL = 'JUNIOR HIGH' AND TBL_STUDENT_REGISTERED.ACADEMIC_YEAR = @ay ORDER BY LASTNAME,FIRSTNAME ASC"
                Case "YEAR LEVEL"
                    SQLQuery = "SELECT ROWID,TBL_STUDENT_INFORMATION.STUDENT_NUMBER,LASTNAME + CASE EXTENSION_NAME WHEN 'N.A' THEN '' WHEN '' THEN '' ELSE ' ' + EXTENSION_NAME END + ', ' + FIRSTNAME + ' ' + CASE MIDDLENAME WHEN 'N.A' THEN '' WHEN '' THEN '' ELSE ' ' + MIDDLENAME END AS STUDENT_NAME,COURSECODE,YRLVL,SECTIONCODE,REGISTEREDDATE,REGISTEREDBY FROM TBL_STUDENT_INFORMATION INNER JOIN TBL_STUDENT_REGISTERED ON TBL_STUDENT_INFORMATION.STUDENT_NUMBER = TBL_STUDENT_REGISTERED.STUDENT_NUMBER WHERE YRLVL LIKE @search AND TBL_STUDENT_REGISTERED.EDUCATION_LEVEL = 'JUNIOR HIGH' AND TBL_STUDENT_REGISTERED.ACADEMIC_YEAR = @ay ORDER BY LASTNAME,FIRSTNAME ASC"
            End Select
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        With frm_registration_highschool_entry
            .MdiParent = frm_main
            .Show()
            .Top = 0
            .Left = 0
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        With frm_registration_highschool_edit
            .DGRow = DGRow
