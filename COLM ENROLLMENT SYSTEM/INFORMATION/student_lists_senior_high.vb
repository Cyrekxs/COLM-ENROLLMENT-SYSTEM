Public Class student_lists_senior_high

    Public DGRow As Integer = 0
    Public Conn As New SqlConnection(StringConnection)

    Public Sub LoadCollegeStudents()
        Using comm As New SqlCommand("SELECT ID,STUDENT_NUMBER,LASTNAME + CASE EXTENSION_NAME WHEN 'N.A' THEN '' WHEN 'NONE' THEN '' WHEN '' THEN '' ELSE ' ' + EXTENSION_NAME END + ' ' + FIRSTNAME + CASE MIDDLENAME WHEN 'N.A' THEN '' WHEN 'NONE' THEN '' WHEN '' THEN '' ELSE ' ' + MIDDLENAME END AS STUDENT_NAME,MOBILE,GENDER, B_MONTH, B_DAY, B_YEAR,GUARDIAN_NAME,GUARDIAN_MOBILE,Street,Brgy,Town,Province FROM TBL_STUDENT_INFORMATION WHERE LASTNAME + CASE EXTENSION_NAME WHEN 'N.A' THEN '' WHEN 'NONE' THEN '' WHEN '' THEN '' ELSE ' ' + EXTENSION_NAME END + ' ' + FIRSTNAME + CASE MIDDLENAME WHEN 'N.A' THEN '' WHEN 'NONE' THEN '' WHEN '' THEN '' ELSE ' ' + MIDDLENAME END LIKE @search AND EDUCATION_LEVEL = @education_level ORDER BY STUDENT_NAME ASC", Conn)
            ...
            Using reader As SqlDataReader = comm.ExecuteReader
                ...
                While reader.Read
                    ...
                    Select Case reader("B_MONTH").ToString.ToUpper()
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        student_information_student_type.txtEducationLevel.Text = "SENIOR HIGH"
